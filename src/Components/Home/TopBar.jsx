    ...
    return (
        <>
            <nav className="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
                ...
                <a className="navbar-brand pe-3 ps-4 ps-lg-2" href="index.html">My Home Tv</a>
                {/* <!-- Navbar Search Input--> */}
                ...
                <ul className="navbar-nav align-items-center ms-auto">
                    ...
                    {/* <!-- Messages Dropdown--> */}
                    <li className="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                        <a className="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownMessages" href="!#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="mail"></i></a>
